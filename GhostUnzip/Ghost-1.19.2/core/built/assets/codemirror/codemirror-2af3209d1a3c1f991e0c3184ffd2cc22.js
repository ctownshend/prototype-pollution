...
r.wrapper.offsetHeight&&(i.scrollTop=t.display.scroller.scrollTop),e.changeObjs&&pe(t,"changes",t,e.changeObjs),e.update&&e.update.finish()}(t[s])}(e)}(i)}}()}function br(e,t){if(e.curOp)return t()
vr(e)
...
return t?t.length?t:null:e}function ln(e,t){var r=function(t,r){var n=r["spans_"+e.id]
if(!n)return null
for(var i=[],o=0;o<r.text.length;++o)i.push(an(n[o]))
return i}(0,t),n=U(e,t)
if(!r)return n
if(!n)return r
...
for(var r=0;r<t.length;r++)this.ranges[r]=new Qo(B(e,t[r].anchor),B(e,t[r].head))},origin:r&&r.origin}
...
return"number"==typeof t?o=L(e,R(e,t)):i=A(t),null==i?null:(n(o,i)&&e.cm&&Sr(e.cm,i,r),o)}function Hn(e){this.lines=e,this.parent=null
for(var t=0,r=0;r<e.length;++r)e[r].parent=this,t+=e[r].height
this.height=t}function En(e){this.children=e
for(var t=0,r=0,n=0;n<e.length;++n){var i=e[n]
t+=i.chunkSize(),r+=i.height,i.parent=this}this.size=t,this.height=r,this.parent=null}function In(e,t,r){le(t)<(e.curOp&&e.curOp.scrollTop||e.doc.scrollTop)&&or(e,r)}function Fn(e,t,r,n,o){if(n&&n.shared)return function(e,t,r,n,i){(n=c(n)).shared=!1
...
return!!r&&(t.shiftKey&&!e.state.keySeq?oi(e,"Shift-"+r,t,function(t){return ii(e,t,!0)})||oi(e,r,t,function(t){if("string"==typeof t?/^go[A-Z]/.test(t):t.motion)return ii(e,t)}):oi(e,r,t,function(t){return ii(e,t)}))}function si(e){if(this.curOp.focus=a(),!ge(this,e)){Bi&&ji<11&&27==e.keyCode&&(e.returnValue=!1)
var t=e.keyCode
this.display.shift=16==t||e.shiftKey
var r=li(this,e)
Ui&&(pa=r?t:null,!r&&88==t&&!No&&(Qi?e.metaKey:e.ctrlKey)&&this.replaceSelection("",null,"cut")),18!=t||/\bCodeMirror-crosshair\b/.test(this.display.lineDiv.className)||function(e){function t(e){18!=e.keyCode&&e.altKey||(oo(r,"CodeMirror-crosshair"),he(document,"keyup",t),he(document,"mouseover",t))}var r=e.display.lineDiv
l(r,"CodeMirror-crosshair"),So(document,"keyup",t),So(document,"mouseover",t)}(this)}}function ui(e){16==e.keyCode&&(this.doc.sel.shift=!1),ge(this,e)}function ci(e){if(!(lt(this.display,e)||ge(this,e)||e.ctrlKey&&!e.altKey||Qi&&e.metaKey)){var t=e.keyCode,r=e.charCode
if(Ui&&t==pa)return pa=null,void be(e)
if(!Ui||e.which&&!(e.which<10)||!li(this,e)){var n=String.fromCharCode(null==r?t:r)
"\b"!=n&&(function(t,r,i){return oi(t,"'"+n+"'",e,function(e){return ii(t,e,!0)})}(this)||this.display.input.onKeyPress(e))}}}function di(e){var t=this.display
if(!(ge(this,e)||t.activeTouch&&t.input.supportsTouch()))if(t.input.ensurePolled(),t.shift=e.shiftKey,lt(t,e))Vi||(t.scroller.draggable=!1,setTimeout(function(){return t.scroller.draggable=!0},100))
else if(!pi(this,e)){var r=Vt(this,e),n=Se(e),i=r?function(e,t){var r=+new Date
return va&&va.compare(r,e,t)?(ma=va=null,"triple"):ma&&ma.compare(r,e,t)?(va=new ga(r,e,t),ma=null,"double"):(ma=new ga(r,e,t),va=null,"single")}(r,n):"single"
window.focus(),1==n&&this.state.selectingText&&this.state.selectingText(e),r&&function(e,t,r,o,a){var l="Click"
return"double"==i?l="Double"+l:"triple"==i&&(l="Triple"+l),l=(1==n?"Left":2==n?"Middle":"Right")+l,oi(e,Xn(l,a),a,function(t){if("string"==typeof t&&(t=fa[t]),!t)return!1
var n=!1
try{e.isReadOnly()&&(e.state.suppressEdits=!0),n=t(e,r)!=fo}finally{e.state.suppressEdits=!1}return n})}(this,0,r,0,e)||(1==n?r?function(e,t,r,n){Bi?setTimeout(u(Xt,e),0):e.curOp.focus=a()
...
p==g?i.push(new Qo(D(v,w),D(v,w))):b.length>w&&i.push(new Qo(D(v,w),D(v,h(b,g,o))))}i.length||i.push(new Qo(r,r)),gn(s,Br(f.ranges.slice(0,c).concat(i),c),{origin:"*mouse",scroll:!1}),e.scrollIntoView(t)}else{var x,k=u,C=fi(e,t,n.unit),S=k.anchor
...
return r.ch==p&&r.sticky==g?t:new Qo(new D(r.line,p,g),n)}(e,new Qo(B(s,S),x)),gn(s,Br(T,c),po)}}(p)
var g=tr(l,s);(p.line>=g.to||p.line<g.from)&&setTimeout(wr(e,function(){y==o&&i(t)}),150)}else{var b=t.clientY<v.top?-20:t.clientY>v.bottom?20:0
b&&setTimeout(wr(e,function(){y==o&&(l.scroller.scrollTop+=b,i(t))}),50)}}function o(t){e.state.selectingText=!1,y=1/0,be(t),l.input.focus(),he(document,"mousemove",b),he(document,"mouseup",w),s.history.lastSelOrigin=null}var l=e.display,s=e.doc
be(t)
var u,c,f=s.sel,p=f.ranges
if(n.addNew&&!n.extend?(c=s.sel.contains(r),u=c>-1?p[c]:new Qo(r,r)):(u=s.sel.primary(),c=s.sel.primIndex),"rectangle"==n.unit)n.addNew||(u=new Qo(r,r)),r=Vt(e,t,!0,!0),c=-1
else{var g=fi(e,r,n.unit)
u=n.extend?un(u,g.anchor,g.head,n.extend):g}n.addNew?-1==c?(c=p.length,gn(s,Br(p.concat([u]),c),{scroll:!1,origin:"*mouse"})):p.length>1&&p[c].empty()&&"char"==n.unit&&!n.extend?(gn(s,Br(p.slice(0,c).concat(p.slice(c+1)),0),{scroll:!1,origin:"*mouse"}),f=s.sel):fn(s,c,u,po):(c=0,gn(s,new Zo([u],0),po),f=s.sel)
var m=r,v=l.wrapper.getBoundingClientRect(),y=0,b=wr(e,function(e){Se(e)?i(e):o(e)}),w=wr(e,o)
e.state.selectingText=w,So(document,"mousemove",b),So(document,"mouseup",w)}(e,n,t,o)}(this,r,i,e):Ce(e)==t.scroller&&be(e):2==n?(r&&cn(this.doc,r),setTimeout(function(){return t.input.focus()},20)):3==n&&(io?gi(this,e):Yt(this)))}}function fi(e,t,r){if("char"==r)return new Qo(t,t)
...
var l=new wi.inputStyles[t.inputStyle](this),s=this.display=new function(e,t,r){this.input=r,this.scrollbarFiller=n("div",null,"CodeMirror-scrollbar-filler"),this.scrollbarFiller.setAttribute("cm-not-content","true"),this.gutterFiller=n("div",null,"CodeMirror-gutter-filler"),this.gutterFiller.setAttribute("cm-not-content","true"),this.lineDiv=i("div",null,"CodeMirror-code"),this.selectionDiv=n("div",null,null,"position: relative; z-index: 1"),this.cursorDiv=n("div",null,"CodeMirror-cursors"),this.measure=n("div",null,"CodeMirror-measure"),this.lineMeasure=n("div",null,"CodeMirror-measure"),this.lineSpace=i("div",[this.measure,this.lineMeasure,this.selectionDiv,this.cursorDiv,this.lineDiv],null,"position: relative; outline: none")
var o=i("div",[this.lineSpace],"CodeMirror-lines")
this.mover=n("div",[o],null,"position: relative"),this.sizer=n("div",[this.mover],"CodeMirror-sizer"),this.sizerWidth=null,this.heightForcer=n("div",null,null,"position: absolute; height: "+co+"px; width: 1px;"),this.gutters=n("div",null,"CodeMirror-gutters"),this.lineGutter=null,this.scroller=n("div",[this.sizer,this.heightForcer,this.gutters],"CodeMirror-scroll"),this.scroller.setAttribute("tabIndex","-1"),this.wrapper=n("div",[this.scrollbarFiller,this.gutterFiller,this.scroller],"CodeMirror"),Bi&&ji<8&&(this.gutters.style.zIndex=-1,this.scroller.style.paddingRight=0),Vi||Ei&&Zi||(this.scroller.draggable=!0),e&&(e.appendChild?e.appendChild(this.wrapper):e(this.wrapper)),this.viewFrom=this.viewTo=t.first,this.reportedViewFrom=this.reportedViewTo=t.first,this.view=[],this.renderedView=null,this.externalMeasured=null,this.viewOffset=0,this.lastWrapHeight=this.lastWrapWidth=0,this.updateLineNumbers=null,this.nativeBarWidth=this.barHeight=this.barWidth=0,this.scrollbarsClipped=!1,this.lineNumWidth=this.lineNumInnerWidth=this.lineNumChars=null,this.alignWidgets=!1,this.cachedCharWidth=this.cachedTextHeight=this.cachedPaddingH=null,this.maxLine=null,this.maxLineLength=0,this.maxLineChanged=!1,this.wheelDX=this.wheelDY=this.wheelStartX=this.wheelStartY=null,this.shift=!1,this.selForContextMenu=null,this.activeTouch=null,r.init(this)}(e,a,l)
...
So(o.scroller,"mousedown",wr(e,di)),So(o.scroller,"dblclick",Bi&&ji<11?wr(e,function(t){if(!ge(e,t)){var r=Vt(e,t)
if(r&&!pi(e,t)&&!lt(e.display,t)){be(t)
var n=e.findWordAt(r)
cn(e.doc,n.anchor,n.head)}}}):function(t){return ge(e,t)||be(t)}),io||So(o.scroller,"contextmenu",function(t){return gi(e,t)})
var a,l={end:0}
...
a=!n.prev||i(n,n.prev)?new Qo(l,l):!n.prev.prev||i(n,n.prev.prev)?e.findWordAt(l):new Qo(D(l.line,0),B(e.doc,D(l.line+1,0))),e.setSelection(a.anchor,a.head),e.focus(),be(r)}t()}),So(o.scroller,"touchcancel",t),So(o.scroller,"scroll",function(){o.scroller.clientHeight&&(cr(e,o.scroller.scrollTop),fr(e,o.scroller.scrollLeft,!0),pe(e,"scroll",e))}),So(o.scroller,"mousewheel",function(t){return Rr(e,t)}),So(o.scroller,"DOMMouseScroll",function(t){return Rr(e,t)}),So(o.wrapper,"scroll",function(){return o.wrapper.scrollTop=o.wrapper.scrollLeft=0}),o.dragFunctions={enter:function(t){ge(e,t)||ke(t)},over:function(t){ge(e,t)||(function(e,i){var o=Vt(e,t)
if(o){var a=document.createDocumentFragment()
qt(e,o,a),e.display.dragCursor||(e.display.dragCursor=n("div",null,"CodeMirror-cursors CodeMirror-dragcursors"),e.display.lineSpace.insertBefore(e.display.dragCursor,e.display.cursorDiv)),r(e.display.dragCursor,a)}}(e),ke(t))},start:function(t){return function(e,t){if(Bi&&(!e.state.draggingText||+new Date-oa<100))ke(t)
...
if("string"==typeof e?t==e:t&&(e.test?e.test(t):e(t)))return++this.pos,t},Do.prototype.eatWhile=function(e){for(var t=this.pos;this.eat(e););return this.pos>t},Do.prototype.eatSpace=function(){for(var e=this.pos;/[\s\u00a0]/.test(this.string.charAt(this.pos));)++this.pos
return this.pos>e},Do.prototype.skipToEnd=function(){this.pos=this.string.length},Do.prototype.skipTo=function(e){var t=this.string.indexOf(e,this.pos)
...
_o.prototype.signal=function(e,t){ve(e,t)&&this.events.push(arguments)},_o.prototype.finish=function(){for(var e=0;e<this.events.length;e++)pe.apply(null,this.events[e])}
var Xo=0,Yo=null
Bi?Yo=-.53:Ei?Yo=15:Gi?Yo=-.7:qi&&(Yo=-1/3)
var Zo=function(e,t){this.ranges=e,this.primIndex=t}
Zo.prototype.primary=function(){return this.ranges[this.primIndex]},Zo.prototype.equals=function(e){if(e==this)return!0
if(e.primIndex!=this.primIndex||e.ranges.length!=this.ranges.length)return!1
for(var t=0;t<this.ranges.length;t++){var r=this.ranges[t],n=e.ranges[t]
if(!H(r.anchor,n.anchor)||!H(r.head,n.head))return!1}return!0},Zo.prototype.deepCopy=function(){for(var e=[],t=0;t<this.ranges.length;t++)e[t]=new Qo(E(this.ranges[t].anchor),E(this.ranges[t].head))
return new Zo(e,this.primIndex)},Zo.prototype.somethingSelected=function(){for(var e=0;e<this.ranges.length;e++)if(!this.ranges[e].empty())return!0
return!1},Zo.prototype.contains=function(e,t){t||(t=e)
for(var r=0;r<this.ranges.length;r++){var n=this.ranges[r]
if(P(t,n.from())>=0&&P(e,n.to())<=0)return r}return-1}
var Qo=function(e,t){this.anchor=e,this.head=t}
Qo.prototype.from=function(){return F(this.anchor,this.head)},Qo.prototype.to=function(){return I(this.anchor,this.head)},Qo.prototype.empty=function(){return this.head.line==this.anchor.line&&this.head.ch==this.anchor.ch},Hn.prototype={chunkSize:function(){return this.lines.length},removeInner:function(e,t){for(var r=e,n=e+t;r<n;++r){var i=this.lines[r]
this.height-=i.height,Ve(i),Ye(i,"delete")}this.lines.splice(e,t)},collapse:function(e){e.push.apply(e,this.lines)},insertInner:function(e,t,r){this.height+=r,this.lines=this.lines.slice(0,e).concat(t).concat(this.lines.slice(e))
for(var n=0;n<t.length;++n)t[n].parent=this},iterN:function(e,t,r){for(var n=e+t;e<n;++e)if(r(this.lines[e]))return!0}},En.prototype={chunkSize:function(){return this.size},removeInner:function(e,t){this.size-=t
...
e=0}else e-=i}if(this.size-t<25&&(this.children.length>1||!(this.children[0]instanceof Hn))){var l=[]
this.collapse(l),this.children=[new Hn(l)],this.children[0].parent=this}},collapse:function(e){for(var t=0;t<this.children.length;++t)this.children[t].collapse(e)},insertInner:function(e,t,r){this.size+=t.length,this.height+=r
for(var n=0;n<this.children.length;++n){var i=this.children[n],o=i.chunkSize()
if(e<=o){if(i.insertInner(e,t,r),i.lines&&i.lines.length>50){for(var a=i.lines.length%25+25,l=a;l<i.lines.length;){var s=new Hn(i.lines.slice(l,l+=25))
...
if(0==(t-=a))break
e=0}else e-=o}}}
var Jo=function(e,t,r){if(r)for(var n in r)r.hasOwnProperty(n)&&(this[n]=r[n])
this.doc=e,this.node=t}
Jo.prototype.clear=function(){var e=this.doc.cm,t=this.line.widgets,r=this.line,n=A(r)
if(null!=n&&t){for(var i=0;i<t.length;++i)t[i]==this&&t.splice(i--,1)
t.length||(r.widgets=null)
var o=at(this)
N(r,Math.max(0,r.height-o)),e&&(br(e,function(){In(e,r,-o),Sr(e,n,"widget")}),Ye(e,"lineWidgetCleared",e,this,n))}},Jo.prototype.changed=function(){var e=this,t=this.height,r=this.doc.cm,n=this.line
this.height=null
var i=at(this)-t
...
ta.prototype.clear=function(){if(!this.explicitlyCleared){var e=this.doc.cm,t=e&&!e.curOp
if(t&&vr(e),ve(this,"clear")){var r=this.find()
r&&Ye(this,"clear",r.from,r.to)}for(var n=null,i=null,o=0;o<this.lines.length;++o){var a=this.lines[o],l=K(a.markedSpans,this)
e&&!this.collapsed?Sr(e,A(a),"text"):e&&(null!=l.to&&(i=A(a)),null!=l.from&&(n=A(a))),a.markedSpans=G(a.markedSpans,l),null==l.from&&this.collapsed&&!oe(this.doc,a)&&e&&N(a,Et(e.display))}if(e&&this.collapsed&&!e.options.lineWrapping)for(var s=0;s<this.lines.length;++s){var u=re(this.lines[s]),c=se(u)
c>e.display.maxLineLength&&(e.display.maxLine=u,e.display.maxLineLength=c,e.display.maxLineChanged=!0)}null!=n&&e&&this.collapsed&&Cr(e,n,i+1),this.lines.length=0,this.explicitlyCleared=!0,this.atomic&&this.doc.cantEdit&&(this.doc.cantEdit=!1,e&&yn(e.doc)),e&&Ye(e,"markerCleared",e,this,n,i),t&&yr(e),this.parent&&this.parent.clear()}},ta.prototype.find=function(e,t){null==e&&"bookmark"==this.type&&(e=1)
for(var r,n,i=0;i<this.lines.length;++i){var o=this.lines[i],a=K(o.markedSpans,this)
if(null!=a.from&&(r=D(t?o:A(o),a.from),-1==e))return r
if(null!=a.to&&(n=D(t?o:A(o),a.to),1==e))return n}return r&&{from:r,to:n}},ta.prototype.changed=function(){var e=this,t=this.find(-1,!0),r=this,n=this.doc.cm
...
var ra=function(e,t){this.markers=e,this.primary=t
for(var r=0;r<e.length;++r)e[r].parent=this}
ra.prototype.clear=function(){if(!this.explicitlyCleared){this.explicitlyCleared=!0
...
return null==e||"head"==e?t.head:"anchor"==e?t.anchor:"end"==e||"to"==e||!1===e?t.to():t.from()},listSelections:function(){return this.sel.ranges},somethingSelected:function(){return this.sel.somethingSelected()},setCursor:kr(function(e,t,r){hn(this,B(this,"number"==typeof e?D(e,t||0):e),null,r)}),setSelection:kr(function(e,t,r){hn(this,B(this,e),B(this,t||e),r)}),extendSelection:kr(function(e,t,r){cn(this,B(this,e),t&&B(this,t),r)}),extendSelections:kr(function(e,t){dn(this,j(this,e),t)}),extendSelectionsBy:kr(function(e,t){dn(this,j(this,m(this.sel.ranges,e)),t)}),setSelections:kr(function(e,t,r){if(e.length){for(var n=[],i=0;i<e.length;i++)n[i]=new Qo(B(this,e[i].anchor),B(this,e[i].head))
null==t&&(t=Math.min(e.length-1,this.sel.primIndex)),gn(this,Br(n,t),r)}}),addSelection:kr(function(e,t,r){var n=this.sel.ranges.slice(0)
n.push(new Qo(B(this,e),B(this,t||e))),gn(this,Br(n,n.length-1),r)}),getSelection:function(e){for(var t,r=this.sel.ranges,n=0;n<r.length;n++){var i=T(this,r[n].from(),r[n].to())
t=t?t.concat(i):i}return!1===e?t:t.join(e||this.lineSeparator())},getSelections:function(e){for(var t=[],r=this.sel.ranges,n=0;n<r.length;n++){var i=T(this,r[n].from(),r[n].to())
...
this.replaceSelections(n,t,r||"+input")},replaceSelections:kr(function(e,t,r){for(var n=[],i=this.sel,o=0;o<i.ranges.length;o++){var a=i.ranges[o]
n[o]={from:a.from(),to:a.to(),text:this.splitLines(e[o]),origin:r}}for(var l=t&&"end"!=t&&function(e,t,r){for(var n=[],i=D(e.first,0),o=i,a=0;a<t.length;a++){var l=t[a],s=Ur(l.from,i,o),u=Ur(Vr(l),i,o)
if(i=l.to,o=u,"around"==r){var c=e.sel.ranges[a],d=P(c.head,c.anchor)<0
n[a]=new Qo(d?u:s,d?s:u)}else n[a]=new Qo(s,s)}return new Zo(n,e.sel.primIndex)}(this,n,t),s=n.length-1;s>=0;s--)Ln(this,n[s])
l?pn(this,l):this.cm&&ar(this.cm)}),undo:kr(function(){Mn(this,"undo")}),redo:kr(function(){Mn(this,"redo")}),undoSelection:kr(function(){Mn(this,"undo",!0)}),redoSelection:kr(function(){Mn(this,"redo",!0)}),setExtending:function(e){this.extend=e},getExtending:function(){return this.extend},historySize:function(){for(var e=this.history,t=0,r=0,n=0;n<e.done.length;n++)e.done[n].ranges||++t
...
t[i]=o.slice(0,a.index)+(a.index&&l!=o.length?" ":"")+o.slice(l)||null}return!0})}),addLineWidget:kr(function(e,t,r){return function(e,n,i,o){var a=new Jo(e,t,r),l=e.cm
return l&&a.noHScroll&&(l.display.alignWidgets=!0),Pn(e,n,"widget",function(t){var r=t.widgets||(t.widgets=[])
if(null==a.insertAt?r.push(a):r.splice(Math.min(r.length-1,Math.max(0,a.insertAt)),0,a),a.line=t,l&&!oe(e,t)){var n=le(t)<e.scrollTop
N(t,t.height+at(a)),n&&or(l,a.height),l.curOp.forceUpdate=!0}return!0}),Ye(l,"lineWidgetAdded",l,a,"number"==typeof n?n:A(n)),a}(this,e)}),removeLineWidget:function(e){e.clear()},markText:function(e,t,r){return Fn(this,B(this,e),B(this,t),r,r&&r.type||"range")},setBookmark:function(e,t){var r={replacedWith:t&&(null==t.nodeType?t.widget:t),insertLeft:t&&t.insertLeft,clearWhenEmpty:!1,shared:t&&t.shared,handleMouseEvents:t&&t.handleMouseEvents}
...
n.markers.push(l),l.parent=n}}}(n,Rn(this)),n},unlinkDoc:function(e){if(e instanceof wi&&(e=e.doc),this.linked)for(var t=0;t<this.linked.length;++t)if(this.linked[t].doc==e){this.linked.splice(t,1),e.unlinkDoc(this),Bn(Rn(this))
break}if(e.history==this.history){var r=[e.id]
Yr(e,function(e){return r.push(e.id)},!0),e.history=new Jr(null),e.history.done=sn(this.history.done,r),e.history.undone=sn(this.history.undone,r)}},iterLinkedDocs:function(e){Yr(this,e)},getMode:function(){return this.mode},getEditor:function(){return this.cm},splitLines:function(e){return this.lineSep?e.split(this.lineSep):To(e)},lineSeparator:function(){return this.lineSep||"\n"},setDirection:kr(function(e){"rtl"!=e&&(e="ltr"),e!=this.direction&&(this.direction=e,this.iter(function(e){return e.order=null}),this.cm&&function(e){br(e,function(){Qr(e),Cr(e)})}(this.cm))})}),ia.prototype.eachLine=ia.prototype.iter
...
if(Yi&&Gi&&this.cm.options.gutters.length&&function(t){for(var r=e.anchorNode;r;r=r.parentNode)if(/CodeMirror-gutter-wrapper/.test(r.className))return!0
...
e.splice(n,0,t)}(this.state.overlays,{mode:n,modeSpec:t,opaque:r&&r.opaque,priority:r&&r.priority||0},function(e){return e.priority}),this.state.modeGen++,Cr(this)}),removeOverlay:xr(function(e){for(var t=this.state.overlays,r=0;r<t.length;++r){var n=t[r].modeSpec
if(n==e||"string"==typeof e&&n.name==e)return t.splice(r,1),this.state.modeGen++,void Cr(this)}}),indentLine:xr(function(e,t,r){"string"!=typeof t&&"number"!=typeof t&&(t=null==t?this.options.smartIndent?"smart":"prev":t?"add":"subtract"),W(this.doc,e)&&xi(this,e,t,r)}),indentSelection:xr(function(e){for(var t=this.doc.sel.ranges,r=-1,n=0;n<t.length;n++){var i=t[n]
if(i.empty())i.head.line>r&&(xi(this,i.head.line,e,!0),r=i.head.line,n==this.doc.sel.primIndex&&ar(this))
else{var o=i.from(),a=i.to(),l=Math.max(r,o.line)
r=Math.min(this.lastLine(),a.line-(a.ch?0:1))+1
for(var s=l;s<r;++s)xi(this,s,e)
var u=this.doc.sel.ranges
0==o.ch&&t.length==u.length&&u[n].from().ch>0&&fn(this.doc,n,new Qo(o,u[n].to()),ho)}}}),getTokenAt:function(e,t){return Re(this,e,t)},getLineTokens:function(e,t){return Re(this,D(e),t,!0)},getTokenTypeAt:function(e){e=B(this.doc,e)
...
else if("above"==n||"near"==n){var s=Math.max(o.wrapper.clientHeight,this.doc.height),u=Math.max(o.sizer.clientWidth,o.lineSpace.clientWidth);("above"==n||e.bottom+t.offsetHeight>s)&&e.top>t.offsetHeight?a=e.top-t.offsetHeight:e.bottom+t.offsetHeight<=s&&(a=e.bottom),l+t.offsetWidth>u&&(l=u-t.offsetWidth)}t.style.top=a+"px",t.style.left=t.style.right="","right"==i?(l=o.sizer.clientWidth-t.offsetWidth,t.style.right="0px"):("left"==i?l=0:"middle"==i&&(l=(o.sizer.clientWidth-t.offsetWidth)/2),t.style.left=l+"px"),r&&function(e,r){var n=ir(e,{left:l,top:a,right:l+t.offsetWidth,bottom:a+t.offsetHeight})
null!=n.scrollTop&&cr(e,n.scrollTop),null!=n.scrollLeft&&fr(e,n.scrollLeft)}(this)},triggerOnKeyDown:xr(si),triggerOnKeyPress:xr(ci),triggerOnKeyUp:ui,triggerOnMouseDown:xr(di),execCommand:function(e){if(fa.hasOwnProperty(e))return fa[e].call(null,this)},triggerElectric:xr(function(e){Li(this,e)}),findPosH:function(e,t,r,n){var i=1
t<0&&(i=-1,t=-t)
for(var o=B(this.doc,e),a=0;a<t&&!(o=Ai(this.doc,o,i,r,n)).hitSide;++a);return o},moveH:xr(function(e,t){var r=this
...
t<0&&(i=-1,t=-t)
for(var a=B(this.doc,e),l=0;l<t;++l){var s=At(this,a,"div")
if(null==o?o=s.left:s.left=o,(a=Oi(this,s,i,r)).hitSide)break}return a},moveV:xr(function(e,t){var r=this,n=this.doc,i=[],o=!this.display.shift&&!n.extend&&n.sel.somethingSelected()
...
e.defineMode("javascript",function(t,r){function n(e,t,r){return Se=e,Le=r,t}function i(e,t){var r=e.next()
if('"'==r||"'"==r)return t.tokenize=function(e){return function(t,r){var o,a=!1
if(Ne&&"@"==t.peek()&&t.match(Pe))return r.tokenize=i,n("jsonld-keyword","meta")
...
if("/"==r)return e.eat("*")?(t.tokenize=o,o(e,t)):e.eat("/")?(e.skipToEnd(),n("comment","comment")):Ce(e,t,1)?(function(e){for(var t,r=!1,n=!1;null!=(t=e.next());){if(!r){if("/"==t&&!n)return
...
if(De.test(r))return">"==r&&t.lexical&&">"==t.lexical.type||(e.eat("=")?"!"!=r&&"="!=r||e.eat("="):/[<>*+\-]/.test(r)&&(e.eat(r),">"==r&&e.eat(r))),n("operator","operator",e.current())
if(We.test(r)){e.eatWhile(We)
var l=e.current()
if("."!=t.lastType){if(ze.propertyIsEnumerable(l)){var s=ze[l]
...
if(!(r<0)){if(Oe){var n=/:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(e.string.slice(e.start,r))
n&&(r=n.index)}for(var i=0,o=!1,a=r-1;a>=0;--a){var l=e.string.charAt(a),s=He.indexOf(l)
if(s>=0&&s<3){if(!i){++a
break}if(0==--i){"("==l&&(o=!0)
break}}else if(s>=3&&s<6)++i
else if(We.test(l))o=!0
else{if(/["'\/]/.test(l))return
if(o&&!i){++a
break}}}o&&!i&&(t.fatArrowAt=a)}}function s(e,t,r,n,i,o){this.indented=e,this.column=t,this.type=r,this.prev=i,this.info=o,null!=n&&(this.align=n)}function u(e,t){for(var r=e.localVars;r;r=r.next)if(r.name==t)return!0
for(var n=e.context;n;n=n.prev)for(r=n.vars;r;r=r.next)if(r.name==t)return!0}function c(){for(var e=arguments.length-1;e>=0;e--)Ie.cc.push(arguments[e])}function d(){return c.apply(null,arguments),!0}function f(e){function t(t){for(var r=t;r;r=r.next)if(r.name==e)return!0
return!1}var n=Ie.state
if(Ie.marked="def",n.context){if(t(n.localVars))return
n.localVars={name:e,next:n.localVars}}else{if(t(n.globalVars))return
r.globalVars&&(n.globalVars={name:e,next:n.globalVars})}}function h(){Ie.state.context={prev:Ie.state.context,vars:Ie.state.localVars},Ie.state.localVars=Fe}function p(){Ie.state.localVars=Ie.state.context.vars,Ie.state.context=Ie.state.context.prev}function g(e,t){var r=function(){var r=Ie.state,n=r.indented
...
return r.lex=!0,r}function m(){var e=Ie.state
e.lexical.prev&&(")"==e.lexical.type&&(e.indented=e.lexical.indented),e.lexical=e.lexical.prev)}function v(e){function t(r){return r==e?d():";"==e?c():d(t)}return t}function y(e,t){return"var"==e?d(g("vardef",t.length),Z,v(";"),m):"keyword a"==e?d(g("form"),x,y,m):"keyword b"==e?d(g("form"),y,m):"keyword d"==e?Ie.stream.match(/^\s*$/,!1)?d():d(g("stat"),C,v(";"),m):"debugger"==e?d(v(";")):"{"==e?d(g("}"),R,m):";"==e?d():"if"==e?("else"==Ie.state.lexical.info&&Ie.state.cc[Ie.state.cc.length-1]==m&&Ie.state.cc.pop()(),d(g("form"),x,y,m,re)):"function"==e?d(se):"for"==e?d(g("form"),ne,y,m):"variable"==e?Oe&&"type"==t?(Ie.marked="keyword",d(K,v("operator"),K,v(";"))):Oe&&"declare"==t?(Ie.marked="keyword",d(y)):Oe&&("module"==t||"enum"==t)&&Ie.stream.match(/^\s*\w/,!1)?(Ie.marked="keyword",d(g("form"),Q,v("{"),g("}"),R,m,m)):d(g("stat"),z):"switch"==e?d(g("form"),x,v("{"),g("}","switch"),R,m,m):"case"==e?d(b,v(":")):"default"==e?d(v(":")):"catch"==e?d(g("form"),h,v("("),ue,v(")"),y,m,p):"class"==e?d(g("form"),de,m):"export"==e?d(g("stat"),ge,m):"import"==e?d(g("stat"),ve,m):"async"==e?d(y):"@"==t?d(b,y):c(g("stat"),b,v(";"),m)}function b(e){return k(e,!1)}function w(e){return k(e,!0)}function x(e){return"("!=e?c():d(g(")"),b,v(")"),m)}function k(e,t){if(Ie.state.fatArrowAt==Ie.stream.start){var r=t?A:N
if("("==e)return d(h,g(")"),I(ue,")"),m,v("=>"),r,p)
if("variable"==e)return c(h,Q,v("=>"),r,p)}var n=t?L:S
return Ee.hasOwnProperty(e)?d(n):"function"==e?d(se,n):"class"==e?d(g("form"),ce,m):"keyword c"==e||"async"==e?d(t?w:b):"("==e?d(g(")"),C,v(")"),m,n):"operator"==e||"spread"==e?d(t?w:b):"["==e?d(g("]"),ke,m,n):"{"==e?F(P,"}",null,n):"quasi"==e?c(T,n):"new"==e?d(function(e){return function(t){return"."==t?d(e?W:O):"variable"==t&&Oe?d(_,e?L:S):c(e?w:b)}}(t)):d()}function C(e){return e.match(/[;\}\)\],]/)?c():c(b)}function S(e,t){return","==e?d(b):L(e,t,!1)}function L(e,t,r){var n=0==r?S:L,i=0==r?b:w
return"=>"==e?d(h,r?A:N,p):"operator"==e?/\+\+|--/.test(t)||Oe&&"!"==t?d(n):Oe&&"<"==t&&Ie.stream.match(/^([^>]|<.*?>)*>\s*\(/,!1)?d(g(">"),I(K,">"),m,n):"?"==t?d(b,v(":"),i):d(i):"quasi"==e?c(T,n):";"!=e?"("==e?F(w,")","call",n):"."==e?d(D,n):"["==e?d(g("]"),C,v("]"),m,n):Oe&&"as"==t?(Ie.marked="keyword",d(K,n)):"regexp"==e?(Ie.state.lastType=Ie.marked="operator",Ie.stream.backUp(Ie.stream.pos-Ie.stream.start-1),d(i)):void 0:void 0}function T(e,t){return"quasi"!=e?c():"${"!=t.slice(t.length-2)?d(T):d(b,M)}function M(e){if("}"==e)return Ie.marked="string-2",Ie.state.tokenize=a,d(T)}function N(e){return l(Ie.stream,Ie.state),c("{"==e?y:b)}function A(e){return l(Ie.stream,Ie.state),c("{"==e?y:w)}function O(e,t){if("target"==t)return Ie.marked="keyword",d(S)}function W(e,t){if("target"==t)return Ie.marked="keyword",d(L)}function z(e){return":"==e?d(m,y):c(S,v(";"),m)}function D(e){if("variable"==e)return Ie.marked="property",d()}function P(e,t){if("async"==e)return Ie.marked="property",d(P)
if("variable"==e||"keyword"==Ie.style){if(Ie.marked="property","get"==t||"set"==t)return d(H)
var r
return Oe&&Ie.state.fatArrowAt==Ie.stream.start&&(r=Ie.stream.match(/^\s*:\s*/,!1))&&(Ie.state.fatArrowAt=Ie.stream.pos+r[0].length),d(E)}return"number"==e||"string"==e?(Ie.marked=Ne?"property":Ie.style+" property",d(E)):"jsonld-keyword"==e?d(E):"modifier"==e?d(P):"["==e?d(b,v("]"),E):"spread"==e?d(w,E):"*"==t?(Ie.marked="keyword",d(P)):":"==e?c(E):void 0}function H(e){return"variable"!=e?c(E):(Ie.marked="property",d(se))}function E(e){return":"==e?d(w):"("==e?c(se):void 0}function I(e,t,r){function n(i,o){if(r?r.indexOf(i)>-1:","==i){var a=Ie.state.lexical
return"call"==a.info&&(a.pos=(a.pos||0)+1),d(function(r,n){return r==t||n==t?c():c(e)},n)}return i==t||o==t?d():d(v(t))}return function(r,i){return r==t||i==t?d():c(e,n)}}function F(e,t,r){for(var n=3;n<arguments.length;n++)Ie.cc.push(arguments[n])
return d(g(t,r),I(e,t),m)}function R(e){return"}"==e?d():c(y,R)}function B(e,t){if(Oe){if(":"==e)return d(K)
if("?"==t)return d(B)}}function j(e){if(Oe&&":"==e)return Ie.stream.match(/^\s*\w+\s+is\b/,!1)?d(b,V,K):d(K)}function V(e,t){if("is"==t)return Ie.marked="keyword",d()}function K(e,t){return"variable"==e||"void"==t?"keyof"==t?(Ie.marked="keyword",d(K)):(Ie.marked="type",d($)):"string"==e||"number"==e||"atom"==e?d($):"["==e?d(g("]"),I(K,"]",","),m,$):"{"==e?d(g("}"),I(U,"}",",;"),m,$):"("==e?d(I(q,")"),G):void 0}function G(e){if("=>"==e)return d(K)}function U(e,t){return"variable"==e||"keyword"==Ie.style?(Ie.marked="property",d(U)):"?"==t?d(U):":"==e?d(K):"["==e?d(b,B,v("]"),U):void 0}function q(e){return"variable"==e?d(q):":"==e?d(K):void 0}function $(e,t){return"<"==t?d(g(">"),I(K,">"),m,$):"|"==t||"."==e?d(K):"["==e?d(v("]"),$):"extends"==t?d(K):void 0}function _(e,t){if("<"==t)return d(g(">"),I(K,">"),m,$)}function X(){return c(K,Y)}function Y(e,t){if("="==t)return d(K)}function Z(){return c(Q,B,ee,te)}function Q(e,t){return"modifier"==e?d(Q):"variable"==e?(f(t),d()):"spread"==e?d(Q):"["==e?F(Q,"]"):"{"==e?F(J,"}"):void 0}function J(e,t){return"variable"!=e||Ie.stream.match(/^\s*:/,!1)?("variable"==e&&(Ie.marked="property"),"spread"==e?d(Q):"}"==e?c():d(v(":"),Q,ee)):(f(t),d(ee))}function ee(e,t){if("="==t)return d(w)}function te(e){if(","==e)return d(Z)}function re(e,t){if("keyword b"==e&&"else"==t)return d(g("form","else"),y,m)}function ne(e){if("("==e)return d(g(")"),ie,v(")"),m)}function ie(e){return"var"==e?d(Z,v(";"),ae):";"==e?d(ae):"variable"==e?d(oe):c(b,v(";"),ae)}function oe(e,t){return"in"==t||"of"==t?(Ie.marked="keyword",d(b)):d(S,ae)}function ae(e,t){return";"==e?d(le):"in"==t||"of"==t?(Ie.marked="keyword",d(b)):c(b,v(";"),le)}function le(e){")"!=e&&d(b)}function se(e,t){return"*"==t?(Ie.marked="keyword",d(se)):"variable"==e?(f(t),d(se)):"("==e?d(h,g(")"),I(ue,")"),m,j,y,p):Oe&&"<"==t?d(g(">"),I(X,">"),m,se):void 0}function ue(e,t){return"@"==t&&d(b,ue),"spread"==e||"modifier"==e?d(ue):c(Q,B,ee)}function ce(e,t){return"variable"==e?de(e,t):fe(e,t)}function de(e,t){if("variable"==e)return f(t),d(fe)}function fe(e,t){return"<"==t?d(g(">"),I(X,">"),m,fe):"extends"==t||"implements"==t||Oe&&","==e?d(Oe?K:b,fe):"{"==e?d(g("}"),he,m):void 0}function he(e,t){return"modifier"==e||"async"==e||"variable"==e&&("static"==t||"get"==t||"set"==t)&&Ie.stream.match(/^\s+[\w$\xa1-\uffff]/,!1)?(Ie.marked="keyword",d(he)):"variable"==e||"keyword"==Ie.style?(Ie.marked="property",d(Oe?pe:se,he)):"["==e?d(b,v("]"),Oe?pe:se,he):"*"==t?(Ie.marked="keyword",d(he)):";"==e?d(he):"}"==e?d():"@"==t?d(b,he):void 0}function pe(e,t){return"?"==t?d(pe):":"==e?d(K,ee):"="==t?d(w):c(se)}function ge(e,t){return"*"==t?(Ie.marked="keyword",d(xe,v(";"))):"default"==t?(Ie.marked="keyword",d(b,v(";"))):"{"==e?d(I(me,"}"),xe,v(";")):c(y)}function me(e,t){return"as"==t?(Ie.marked="keyword",d(v("variable"))):"variable"==e?c(w,me):void 0}function ve(e){return"string"==e?d():c(ye,be,xe)}function ye(e,t){return"{"==e?F(ye,"}"):("variable"==e&&f(t),"*"==t&&(Ie.marked="keyword"),d(we))}function be(e){if(","==e)return d(ye,be)}function we(e,t){if("as"==t)return Ie.marked="keyword",d(ye)}function xe(e,t){if("from"==t)return Ie.marked="keyword",d(b)}function ke(e){return"]"==e?d():c(I(w,"]"))}function Ce(e,t,r){return t.tokenize==i&&/^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType)||"quasi"==t.lastType&&/\{\s*$/.test(e.string.slice(0,e.pos-(r||0)))}var Se,Le,Te=t.indentUnit,Me=r.statementIndent,Ne=r.jsonld,Ae=r.json||Ne,Oe=r.typescript,We=r.wordCharacters||/[\w$\xa1-\uffff]/,ze=function(){function e(e){return{type:e,style:"keyword"}}var t=e("keyword a"),r=e("keyword b"),n=e("keyword c"),i=e("keyword d"),o=e("operator"),a={type:"atom",style:"atom"},l={if:e("if"),while:t,with:t,else:r,do:r,try:r,finally:r,return:i,break:i,continue:i,new:e("new"),delete:n,void:n,throw:n,debugger:e("debugger"),var:e("var"),const:e("var"),let:e("var"),function:e("function"),catch:e("catch"),for:e("for"),switch:e("switch"),case:e("case"),default:e("default"),in:o,typeof:o,instanceof:o,true:a,false:a,null:a,undefined:a,NaN:a,Infinity:a,this:e("this"),class:e("class"),super:e("atom"),yield:n,export:e("export"),import:e("import"),extends:n,await:n}
if(Oe){var s={type:"variable",style:"type"},u={interface:e("class"),implements:n,namespace:n,public:e("modifier"),private:e("modifier"),protected:e("modifier"),abstract:e("modifier"),readonly:e("modifier"),string:s,number:s,boolean:s,any:s}
for(var c in u)l[c]=u[c]}return l}(),De=/[+\-*&%=<>!?|~^@]/,Pe=/^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/,He="([{}])",Ee={atom:!0,number:!0,variable:!0,string:!0,regexp:!0,this:!0,"jsonld-keyword":!0},Ie={state:null,column:null,marked:null,cc:null},Fe={name:"this",next:{name:"arguments"}}
return m.lex=!0,{startState:function(e){var t={tokenize:i,lastType:"sof",cc:[],lexical:new s((e||0)-Te,0,"block",!1),localVars:r.localVars,context:r.localVars&&{vars:r.localVars},indented:e||0}
...
return"comment"==Se?r:(t.lastType="operator"!=Se||"++"!=Le&&"--"!=Le?Se:"incdec",function(e,t,r,n,i){var o=e.cc
for(Ie.state=e,Ie.stream=i,Ie.marked=null,Ie.cc=o,Ie.style=t,e.lexical.hasOwnProperty("align")||(e.lexical.align=!0);;)if((o.length?o.pop():Ae?b:y)(r,n)){for(;o.length&&o[o.length-1].lex;)o.pop()()
return Ie.marked?Ie.marked:"variable"==r&&u(e,n)?"variable-2":t}}(t,r,Se,Le,e))},indent:function(t,n){if(t.tokenize==o)return e.Pass
if(t.tokenize!=i)return 0
var a,l=n&&n.charAt(0),s=t.lexical
if(!/^\s*else\b/.test(n))for(var u=t.cc.length-1;u>=0;--u){var c=t.cc[u]
if(c==m)s=s.prev
else if(c!=re)break}for(;("stat"==s.type||"form"==s.type)&&("}"==l||(a=t.cc[t.cc.length-1])&&(a==S||a==L)&&!/^[,\.=+\-*:?[\(]/.test(n));)s=s.prev
Me&&")"==s.type&&"stat"==s.prev.type&&(s=s.prev)
var d=s.type,f=l==d
return"vardef"==d?s.indented+("operator"==t.lastType||","==t.lastType?s.info+1:0):"form"==d&&"{"==l?s.indented:"form"==d?s.indented+Te:"stat"==d?s.indented+(function(e,t){return"operator"==e.lastType||","==e.lastType||De.test(t.charAt(0))||/[,.]/.test(t.charAt(0))}(t,n)?Me||Te:0):"switch"!=s.info||f||0==r.doubleIndentSwitch?s.align?s.column+(f?0:1):s.indented+(f?0:Te):s.indented+(/^(?:case|default)\b/.test(n)?Te:2*Te)},electricInput:/^\s*(?:case .*?:|default:|\{|\})$/,blockCommentStart:Ae?null:"/*",blockCommentEnd:Ae?null:"*/",blockCommentContinue:Ae?null:" * ",lineComment:Ae?null:"//",fold:"brace",closeBrackets:"()[]{}''\"\"``",helperType:Ae?"json":"javascript",jsonldMode:Ne,jsonMode:Ae,expressionAllowed:Ce,skipExpression:function(e){var t=e.cc[e.cc.length-1]
...
return"<"==n?e.eat("!")?e.eat("[")?e.match("CDATA[")?r(l("atom","]]>")):null:e.match("--")?r(l("comment","--\x3e")):e.match("DOCTYPE",!0,!0)?(e.eatWhile(/[\w\._\-]/),r(s(1))):null:e.eat("?")?(e.eatWhile(/[\w\._\-]/),t.tokenize=l("meta","?>"),"meta"):(S=e.eat("/")?"closeTag":"openTag",t.tokenize=a,"tag bracket"):"&"==n?(e.eat("#")?e.eat("x")?e.eatWhile(/[a-fA-F\d]/)&&e.eat(";"):e.eatWhile(/[\d]/)&&e.eat(";"):e.eatWhile(/[\w\.\-:]/)&&e.eat(";"))?"atom":"error":(e.eatWhile(/[^&<]/),null)}function a(e,t){var r=e.next()
if(">"==r||"/"==r&&e.eat(">"))return t.tokenize=o,S=">"==r?"endTag":"selfcloseTag","tag bracket"
...
if(r=e.context.tagName,!x.contextGrabbers.hasOwnProperty(r)||!x.contextGrabbers[r].hasOwnProperty(t))return
u(e)}}function d(e,t,r){return"openTag"==e?(r.tagStart=t.column(),f):"closeTag"==e?h:d}function f(e,t,r){return"word"==e?(r.tagName=t.current(),L="tag",m):(L="error",f)}function h(e,t,r){if("word"==e){var n=t.current()
return r.context&&r.context.tagName!=n&&x.implicitlyClosed.hasOwnProperty(r.context.tagName)&&u(r),r.context&&r.context.tagName==n||!1===x.matchClosing?(L="tag",p):(L="tag error",g)}return L="error",g}function p(e,t,r){return"endTag"!=e?(L="error",p):(u(r),d)}function g(e,t,r){return L="error",p(e,0,r)}function m(e,t,r){if("word"==e)return L="attribute",v
if("endTag"==e||"selfcloseTag"==e){var n=r.tagName,i=r.tagStart
return r.tagName=r.tagStart=null,"selfcloseTag"==e||x.autoSelfClosers.hasOwnProperty(n)?c(r,n):(c(r,n),r.context=new function(e,t,r){this.prev=e.context,this.tagName=t,this.indent=e.indented,this.startOfLine=r,(x.doNotIndent.hasOwnProperty(t)||e.context&&e.context.noIndent)&&(this.noIndent=!0)}(r,n,i==r.indented)),d}return L="error",m}function v(e,t,r){return"equals"==e?y:(x.allowMissing||(L="error"),m(e,0,r))}function y(e,t,r){return"string"==e?b:"word"==e&&x.allowUnquoted?(L="string",m):(L="error",m(e,0,r))}function b(e,t,r){return"string"==e?b:m(e,0,r)}var w=n.indentUnit,x={},k=i.htmlMode?t:r
for(var C in k)x[C]=k[C]
for(var C in i)x[C]=i[C]
var S,L
...
S=null
var r=t.tokenize(e,t)
return(r||S)&&"comment"!=r&&(L=null,t.state=t.state(S||r,e,t),L&&(r="error"==L?r+" error":L)),r},indent:function(t,r,n){var i=t.context
...
if(t.tagName)return!1!==x.multilineTagIndentPastTag?t.tagStart+t.tagName.length+2:t.tagStart+w*(x.multilineTagIndentFactor||1)
if(x.alignCDATA&&/<!\[CDATA\[/.test(r))return 0
var l=r&&/^<(\/)?([\w_:\.-]*)/.exec(r)
if(l&&l[1])for(;i;){if(i.tagName==l[2]){i=i.prev
break}if(!x.implicitlyClosed.hasOwnProperty(i.tagName))break
i=i.prev}else if(l)for(;i;){var s=x.contextGrabbers[i.tagName]
if(!s||!s.hasOwnProperty(l[2]))break
i=i.prev}for(;i&&i.prev&&!i.startOfLine;)i=i.prev
return i?i.indent+w:t.baseIndent||0},electricInput:/<\/[\s\w:]+>$/,blockCommentStart:"\x3c!--",blockCommentEnd:"--\x3e",configuration:x.htmlMode?"html":"xml",helperType:x.htmlMode?"html":"xml",skipAttribute:function(e){e.state==y&&(e.state=m)}}}),e.defineMIME("text/xml","xml"),e.defineMIME("application/xml","xml"),e.mimeModes.hasOwnProperty("text/html")||e.defineMIME("text/html",{name:"xml",htmlMode:!0})})
